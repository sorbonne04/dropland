...
const chalk = require('chalk');
  ...
  bot.user.setActivity("+help - dropland");
});
...
bot.on("message", message => {
    if (message.channel.id === config.botChannel) { 
        ...
        if (command === "gen") {
            if (generated.has(message.author.id)) {
                ...
                const embed = {
                    ...
                    footer: {
                        icon_url:
                            "https://media.discordapp.net/attachments/807787285131165767/808694269837574164/image0.gif",
                        text: "Développé par sorbonne04"
                    },
                    image: {url:"https://media.discordapp.net/attachments/807787285131165767/808694269837574164/image0.gif"},
                    author: {
                ...
                fs.readFile(filePath, function (err, data) {
                    if (!err) {
                        ...
                        if (position != -1) {
                            ...
                            fs.writeFile(filePath, data, function (err) {
                                const embed = {
                                    ...
                                    timestamp: new Date(),
                                    footer: {
                                        icon_url: "https://media.discordapp.net/attachments/807787285131165767/808694269837574164/image0.gif",
                                        text: "Développé par sorbonne04"
                                    },
                                    image: {
                                        url:
                        ...
                        const embed = {
                            ...
                            image: {url:"https://media.discordapp.net/attachments/807787285131165767/808686064016818216/image0.gif"},
                            author: {
                                     name: botname + " - générateur de compte",
                                     url: "https://discord.gg/cGt8e7YPfX",
                                icon_url: bot.displayAvatarURL
            ...
            if (command === "help") {
                ...
                const embed = {
                    ...
                    author: {
                        ...
                        url: 'https://media.discordapp.net/attachments/807787285131165767/808686064016818216/image0.gif',
                    },
                    image: {url:"https://media.discordapp.net/attachments/807787285131165767/808686064016818216/image0.gif"},
                    ...
                    footer: {
                        text: 'Développé par sorbonne04',
                        icon_url: 'https://media.discordapp.net/attachments/807787285131165767/808686064016818216/image0.gif',
                    },
                };
                message.channel.send({ embed });
            }
        ...
        if (command === "add") {
            ...
            fs.appendFile(filePath, os.EOL + args[0], function (err) {
                ...
                const embed = {
                    ...
                    image: {url:"https://discord.com/channels/807762251230347294/807787285131165767/808686066285805609"},
                    author: {
                        name: botname + " - générateur de compte",
                        url: "https://discord.gg/cGt8e7YPfX",
                        icon_url: bot.displayAvatarURL
        ...
        if (command === "create") {
            ...
            let args = messageArray.slice(1);
            const filePath = __dirname + "/comptes/" + args[0] + ".txt";
            fs.writeFile(filePath, 'sorbonne04:sorbone04', function (err) {
                if (err) throw err;
                const embed = {
                    title: "Service créé!",
